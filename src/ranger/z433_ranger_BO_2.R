...
hs  <- makeParamSet(
          makeIntegerParam("num.trees" ,        lower=  3300L, upper= 3550L),  #la letra L al final significa ENTERO
          makeIntegerParam("max.depth",         lower=    4L, upper=   30L),  # 0 significa profundidad infinita
