...
num_trees         <-  250    #voy a generar 20 arboles, a mas arboles mas tiempo de proceso y MEJOR MODELO
feature_fraction  <-   0.08#entreno cada arbol con solo 50% de las variables variables
