...
matriz_perdida  <- matrix(c( 0, 600, 1,   1,0,1,   1, 600 ,0), nrow = 3)

num_trees         <-  500    #voy a generar 20 arboles, a mas arboles mas tiempo de proceso y MEJOR MODELO
feature_fraction  <-   0.25#entreno cada arbol con solo 50% de las variables variables

set.seed(200213) #Establezco la semilla aleatoria, cambiar por SU primer semilla
...
pdf( "./labo/exp/KA2101/arbolitos2.pdf", paper="a4r" )
...
fwrite( tb_ensembles,
        file="./labo/exp/KA2101/ensemble2.csv",
        sep="\t" )
