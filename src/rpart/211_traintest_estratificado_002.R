...
dataset  <- fread("C:/Users/Administrator/Desktop/datamining/datasets/paquete_premium_202011.csv")

#particiono estratificadamente el dataset
particionar( dataset, division=c(70,30), agrupa="clase_ternaria", seed= 200213 )  #Cambiar por la primer semilla de cada uno !
