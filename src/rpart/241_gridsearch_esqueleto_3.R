...
ksemillas  <- c(200213, 280108, 901303, 061989, 150651) #reemplazar por las propias semillas
...
for( vmax_depth  in  c( 4.5, 5, 5.5, 6, 6.5, 7, 7.5, 8)  )
{
for( vmin_bucket  in  c( 750, 700, 650, 600, 550, 500, 450, 400)  )
{
for( vmin_split  in  c( 2000, 1800, 1600, 1550, 1500, 1450, 1400, 1300, 1200, 1000 )  )
{    
  
  #Condicion de relación entre min bucket y min split
