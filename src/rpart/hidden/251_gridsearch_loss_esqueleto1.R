...
ArbolEstimarGanancia  <- function( semilla, param_basicos, peso_error )
{
  ...
  matriz_perdida  <- matrix(c( 0,peso_error,0.5,   1,0,1,   0.5,peso_error,0), nrow = 3)
...
{
for( vmin_bucket  in  c( 550, 525, 500, 475, 450)  )
{
for( vmin_split  in  c( 1550, 1500, 1450, 1400, 1350, 1300, 1250)  )
{
for( vpeso_error  in  c( 5, 10, 59, 60, 120) )
{
